-- ============================================================
-- DOCTOR V1 — MEDICAL OPERATIONS FIRST 10 MASTER UPGRADE
-- Generated from canonical production_upgrade migrations 02..20.
-- RUN THIS FILE ONCE in Supabase SQL Editor after taking a backup.
-- DO NOT run history/00_RUN_BACKEND_V10_ONCE_DO_NOT_RUN.sql,
-- doctor_v1_supabase_clean.sql, historical supabase/migrations/*, root step*.sql,
-- or demo-data cleanup scripts.
-- This master is intentionally transactional: any SQL error rolls back the batch.
-- SQL compatibility hotfix: preserves legacy function parameter names and explicitly
-- replaces functions whose TABLE return shape changes.
-- ============================================================
